...
export const Dashboard = () => {
  const [selectedContent, setSelectedContent] = useState(<Teste />);
  ...
  useEffect(() => {
    // Simula o carregamento de todos os dados e componentes
    const loadPage = async () => {
      await new Promise((resolve) => setTimeout(resolve, 500)); // Simula um atraso
      setIsPageLoading(false); // Marca o carregamento como concluído
    };
    loadPage();
  }, []);
